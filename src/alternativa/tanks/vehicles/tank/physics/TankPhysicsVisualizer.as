package alternativa.tanks.vehicles.tank.physics
{
   ...
   import alternativa.tanks.WireBox;
   ...
   public class TankPhysicsVisualizer
   {
      ...
      private function addCollisionPrimitivesToContainer(container:Object3DContainer) : void
      {
         var bb:WireBox = null;
         if(container != null)
         {
      ...
      private function removeCollisionPrimitivesFromContainer(container:Object3DContainer) : void
      {
         var bb:WireBox = null;
         for each(bb in this.bbs)
         {
