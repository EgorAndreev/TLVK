package alternativa.tanks.vehicles.tank.weapons.plasmagun
{
   ...
   import alternativa.tanks.vehicles.tank.weapons.plasmagun.IPlasmaShotListener;
   import alternativa.tanks.vehicles.tank.weapons.plasmagun.PlasmaGunData;
   ...
   public class PlasmaGun extends Weapon implements IPlasmaShotListener
   {
      ...
      private var muzzleNumber:int = 0;
      
      private const plasmaGunData:PlasmaGunData = new PlasmaGunData(shotTravelDistance * 100,shotFadeDistance * 100,shotSpeed * 100,20);
      ...
      override public function update(time:int, delta:int) : void
      {
         if(active && time >= this.readyTime)
         {
            ...
            this.fire();
            barrelDirection.scale(-5000000);
            tank.chassis.addWorldForce(tank.skin.getGlobalMuzzlePosition(this.muzzleNumber),barrelDirection);
         }
      }
      ...
      private function createMuzzleFlash() : void
      {
         ...
         graphicEffect.init(tank.skin.getGlobalMuzzlePosition(this.muzzleNumber),tank.skin.turretMesh,this.muzzleFlashMaterial,FLASH_LIFE_TIME,planeWidth,planeLength);
      ...
      private function createShot() : void
      {
         ...
         shot.init(this.plasmaGunData,tank.skin.getGlobalMuzzlePosition(this.muzzleNumber),barrelDirection,game.getCollisionDetector(),this);
