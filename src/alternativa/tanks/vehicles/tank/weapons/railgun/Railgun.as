package alternativa.tanks.vehicles.tank.weapons.railgun
{
   ...
   public class Railgun extends Weapon
   {
      ...
      private function shoot(time:int) : void
      {
         ...
         barrelDirection.scale(-40000000);
      ...
      private function createShotEffect() : void
      {
         ...
         if(Game.getInstance().getCollisionDetector().raycastStatic(muzzlePosition,barrelDirection,255,1410065408,null,rayHit))
         {
            beamLength = rayHit.t;
            obj = rayData.object;
            ...
            game.getBattleScene3D().addGraphicEffect(powEffect);
         }
      ...
      private function createExplosion(position:Vector3, rotation:Vector3) : void
      {
         ...
         var spriteAnimation:SpriteAnimation = new SpriteAnimation(128,Game.getInstance().config.textureAnimations.getAnimation("railgun_expl"));
         ...
         game.getBattleScene3D().addGraphicEffect(effect2);
